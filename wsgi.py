...
def initialize():
    ...
    print('database intialized but not working ig')
...
def create_user_command(email, firstName, lastName, userType, password):
    create_user(email, firstName, lastName, userType, password)
